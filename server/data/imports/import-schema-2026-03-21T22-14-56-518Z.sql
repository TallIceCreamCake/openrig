...
CREATE OR REPLACE FUNCTION "public"."build_equipment_unit_qr_url"("p_payload" "text") RETURNS "text"
...
ALTER FUNCTION "public"."build_equipment_unit_qr_url"("p_payload" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."build_equipment_unit_qr_value"("p_unit_id" "uuid") RETURNS "text"
    LANGUAGE "sql" IMMUTABLE
    AS $$
...
ALTER FUNCTION "public"."build_equipment_unit_qr_value"("p_unit_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."ensure_equipment_unit_qr_fields"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
  v_payload text;
...
ALTER FUNCTION "public"."ensure_equipment_unit_qr_fields"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."log_equipment_unit_event"("p_equipment_unit_id" "uuid", "p_equipment_id" "uuid", "p_event_type" "text", "p_message" "text", "p_payload" "jsonb" DEFAULT '{}'::"jsonb", "p_severity" "text" DEFAULT 'info'::"text", "p_source" "text" DEFAULT 'app'::"text", "p_rental_id" "uuid" DEFAULT NULL::"uuid", "p_created_by" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
declare
  v_id uuid;
...
ALTER FUNCTION "public"."log_equipment_unit_event"("p_equipment_unit_id" "uuid", "p_equipment_id" "uuid", "p_event_type" "text", "p_message" "text", "p_payload" "jsonb", "p_severity" "text", "p_source" "text", "p_rental_id" "uuid", "p_created_by" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."track_equipment_unit_changes"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
begin
  if tg_op = 'INSERT' then
...
ALTER FUNCTION "public"."track_equipment_unit_changes"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."client_contacts" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "client_contacts_contact_type_check" CHECK (("contact_type" = ANY (ARRAY['email'::"text", 'phone'::"text", 'social'::"text", 'website'::"text", 'other'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."company_settings" (
    ...
    "siret" "text",
    "naf" "text",
    "rental_coefficient_mode" "text" DEFAULT 'none'::"text" NOT NULL,
    "rental_coefficient_formula" "text",
    "rental_coefficient_examples" "jsonb",
    ...
    CONSTRAINT "company_settings_rental_coefficient_mode_check" CHECK (("rental_coefficient_mode" = ANY (ARRAY['none'::"text", 'automatic'::"text", 'formula'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."equipment_unit_activity_logs" (
    ...
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "equipment_unit_activity_logs_severity_check" CHECK (("severity" = ANY (ARRAY['debug'::"text", 'info'::"text", 'warning'::"text", 'error'::"text"])))
);


ALTER TABLE "public"."equipment_unit_activity_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rental_preparation_unit_scans" (
    ...
    CONSTRAINT "rental_preparation_unit_scans_scan_result_check" CHECK (("scan_result" = ANY (ARRAY['accepted'::"text", 'duplicate'::"text", 'wrong_equipment'::"text", 'wrong_code_type'::"text", 'unknown_code'::"text", 'already_completed'::"text", 'forced_accept'::"text"])))
);


ALTER TABLE "public"."rental_preparation_unit_scans" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rental_return_unit_scans" (
    ...
    "scanned_by" "uuid",
    "scanned_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "rental_return_unit_scans_scan_result_check" CHECK (("scan_result" = ANY (ARRAY['accepted'::"text", 'duplicate'::"text", 'wrong_equipment'::"text", 'wrong_code_type'::"text", 'unknown_code'::"text", 'already_returned'::"text", 'not_prepared'::"text", 'forced_accept'::"text"])))
);


ALTER TABLE "public"."rental_return_unit_scans" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rentals" (
    ...
    "title" "text",
    "delivery_offer_id" "uuid",
    "delivery_offer_name" "text",
    "delivery_pricing_type" "text",
    "delivery_rate_amount" numeric,
    "delivery_base_amount" numeric,
    "delivery_quantity" numeric,
    "delivery_round_trip" boolean DEFAULT false,
    "delivery_total_amount" numeric,
    "delivered_at" timestamp with time zone,
    "delivery_confirmation_note" "text",
    "client_represents_company" boolean DEFAULT true NOT NULL,
    "cancelled_at" timestamp with time zone,
    "cancellation_reason" "text",
    "cancellation_payment_policy" "text",
    "cancellation_refund_amount" numeric,
    "status_before_cancellation" "text",
    "quote_expired_at" timestamp with time zone,
    "quote_expired_notice_at" timestamp with time zone,
    "rental_coefficient_override" numeric,
    "return_delivery_at" timestamp with time zone,
    "return_delivery_confirmation_note" "text",
    CONSTRAINT "rentals_discount_type_check" CHECK (("discount_type" = ANY (ARRAY['percentage'::"text", 'fixed'::"text"]))),
    CONSTRAINT "rentals_type_check" CHECK (("type" = ANY (ARRAY['rental'::"text", 'service'::"text", 'sale'::"text"])))
);
...
ALTER VIEW "public"."equipment_unit_rental_history" OWNER TO "postgres";
...
ALTER TABLE "public"."rental_activity_logs" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rental_document_requests" (
    ...
    "decision_code_hash" "text",
    "decision_attempts" integer DEFAULT 0 NOT NULL,
    "decision_last_attempt_at" timestamp with time zone,
    "signer_name" "text",
    "consent_text" "text",
    "consented_at" timestamp with time zone,
    CONSTRAINT "rental_document_requests_doc_type_check" CHECK (("doc_type" = ANY (ARRAY['devis'::"text", 'facture'::"text", 'bon_prepa'::"text"]))),
    CONSTRAINT "rental_document_requests_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'refused'::"text", 'expired'::"text", 'cancelled'::"text"])))
);


ALTER TABLE "public"."rental_document_requests" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_document_shares" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "rental_document_shares_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'revoked'::"text", 'expired'::"text"])))
);


ALTER TABLE "public"."rental_document_shares" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rental_dossier_entries" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "parent_id" "uuid",
    ...
    "color" "text",
    "icon" "text",
    CONSTRAINT "rental_dossier_entries_type_check" CHECK (("entry_type" = ANY (ARRAY['folder'::"text", 'file'::"text"])))
);


ALTER TABLE "public"."rental_dossier_entries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_dossier_share_access_codes" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."rental_dossier_share_access_codes" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_dossier_share_access_sessions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "share_id" "uuid" NOT NULL,
    "email" "text" NOT NULL,
    "token" "text" NOT NULL,
    "expires_at" timestamp with time zone NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "method" "text" DEFAULT 'whitelist'::"text" NOT NULL,
    CONSTRAINT "rental_dossier_share_access_sessions_method_check" CHECK (("method" = ANY (ARRAY['whitelist'::"text", 'password'::"text"])))
);


ALTER TABLE "public"."rental_dossier_share_access_sessions" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_dossier_shares" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "root_entry_id" "uuid",
    "token" "text" NOT NULL,
    ...
    "password_hash" "text",
    "password_salt" "text",
    "access_mode" "text" DEFAULT 'viewer'::"text" NOT NULL,
    "whitelist_enabled" boolean DEFAULT false NOT NULL,
    CONSTRAINT "rental_dossier_shares_access_mode_check" CHECK (("access_mode" = ANY (ARRAY['viewer'::"text", 'editor'::"text"]))),
    CONSTRAINT "rental_dossier_shares_password_check" CHECK (((("password_hash" IS NULL) AND ("password_salt" IS NULL)) OR (("password_hash" IS NOT NULL) AND ("password_salt" IS NOT NULL)))),
    CONSTRAINT "rental_dossier_shares_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'revoked'::"text", 'expired'::"text"])))
);


ALTER TABLE "public"."rental_dossier_shares" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_dossier_whitelist_emails" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "email" "text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
ALTER TABLE "public"."rental_dossier_whitelist_emails" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_dossier_whitelist_verifications" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "email" "text" NOT NULL,
    "code" "text" NOT NULL,
...
ALTER TABLE "public"."rental_dossier_whitelist_verifications" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_insurance_services" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."rental_insurance_services" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."rental_milestone_items" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."rental_milestone_items" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_milestone_personnel" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "milestone_id" "uuid" NOT NULL,
    "personnel_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
ALTER TABLE "public"."rental_milestone_personnel" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_milestone_vehicles" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "milestone_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."rental_milestone_vehicles" OWNER TO "postgres";
...
ALTER TABLE "public"."rental_milestones" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_other_services" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "service_record_id" "uuid" NOT NULL,
    "quantity" integer DEFAULT 1 NOT NULL,
...
ALTER TABLE "public"."rental_other_services" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."rental_personnel_services" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "rental_id" "uuid" NOT NULL,
    "service_record_id" "uuid" NOT NULL,
    "quantity" integer DEFAULT 1 NOT NULL,
    ...
    CONSTRAINT "rental_personnel_services_discount_check" CHECK ((("discount_percent" >= (0)::numeric) AND ("discount_percent" <= (100)::numeric))),
    CONSTRAINT "rental_personnel_services_quantity_check" CHECK (("quantity" > 0))
);


ALTER TABLE "public"."rental_personnel_services" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."service_records" (
    ...
    "category_id" "uuid",
    "subcategory_id" "uuid",
    CONSTRAINT "service_records_category_check" CHECK (("category" = ANY (ARRAY['personnel'::"text", 'insurance'::"text", 'other'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."vehicle_assignments" (
    ...
    "return_delivery_at" timestamp with time zone,
    "return_appointment_at" timestamp with time zone,
...
ALTER TABLE ONLY "public"."delivery_offers"
    ADD CONSTRAINT "delivery_offers_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."equipment_unit_activity_logs"
    ADD CONSTRAINT "equipment_unit_activity_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rental_activity_logs"
    ADD CONSTRAINT "rental_activity_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rental_document_requests"
    ADD CONSTRAINT "rental_document_requests_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_document_requests"
    ADD CONSTRAINT "rental_document_requests_token_key" UNIQUE ("token");



ALTER TABLE ONLY "public"."rental_document_shares"
    ADD CONSTRAINT "rental_document_shares_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_document_shares"
    ADD CONSTRAINT "rental_document_shares_token_key" UNIQUE ("token");
...
ALTER TABLE ONLY "public"."rental_dossier_entries"
    ADD CONSTRAINT "rental_dossier_entries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_share_access_codes"
    ADD CONSTRAINT "rental_dossier_share_access_codes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_share_access_codes"
    ADD CONSTRAINT "rental_dossier_share_access_codes_unique" UNIQUE ("share_id", "email");



ALTER TABLE ONLY "public"."rental_dossier_share_access_sessions"
    ADD CONSTRAINT "rental_dossier_share_access_sessions_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_share_access_sessions"
    ADD CONSTRAINT "rental_dossier_share_access_sessions_token_key" UNIQUE ("token");



ALTER TABLE ONLY "public"."rental_dossier_shares"
    ADD CONSTRAINT "rental_dossier_shares_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_shares"
    ADD CONSTRAINT "rental_dossier_shares_token_key" UNIQUE ("token");



ALTER TABLE ONLY "public"."rental_dossier_whitelist_emails"
    ADD CONSTRAINT "rental_dossier_whitelist_email_unique" UNIQUE ("rental_id", "email");



ALTER TABLE ONLY "public"."rental_dossier_whitelist_emails"
    ADD CONSTRAINT "rental_dossier_whitelist_emails_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_whitelist_verifications"
    ADD CONSTRAINT "rental_dossier_whitelist_verifications_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_dossier_whitelist_verifications"
    ADD CONSTRAINT "rental_dossier_whitelist_verifications_unique" UNIQUE ("rental_id", "email");



ALTER TABLE ONLY "public"."rental_insurance_services"
    ADD CONSTRAINT "rental_insurance_services_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rental_milestone_items"
    ADD CONSTRAINT "rental_milestone_items_milestone_id_rental_item_id_key" UNIQUE ("milestone_id", "rental_item_id");



ALTER TABLE ONLY "public"."rental_milestone_items"
    ADD CONSTRAINT "rental_milestone_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_milestone_personnel"
    ADD CONSTRAINT "rental_milestone_personnel_milestone_id_personnel_id_key" UNIQUE ("milestone_id", "personnel_id");



ALTER TABLE ONLY "public"."rental_milestone_personnel"
    ADD CONSTRAINT "rental_milestone_personnel_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_milestone_vehicles"
    ADD CONSTRAINT "rental_milestone_vehicles_milestone_id_vehicle_id_key" UNIQUE ("milestone_id", "vehicle_id");



ALTER TABLE ONLY "public"."rental_milestone_vehicles"
    ADD CONSTRAINT "rental_milestone_vehicles_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_milestones"
    ADD CONSTRAINT "rental_milestones_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_other_services"
    ADD CONSTRAINT "rental_other_services_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."rental_personnel_services"
    ADD CONSTRAINT "rental_personnel_services_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "client_contacts_contact_type_idx" ON "public"."client_contacts" USING "btree" ("contact_type");



CREATE INDEX "delivery_offers_active_idx" ON "public"."delivery_offers" USING "btree" ("is_active");



CREATE INDEX "equipment_accessories_equipment_id_idx" ON "public"."equipment_accessories" USING "btree" ("equipment_id");



CREATE INDEX "equipment_pack_items_equipment_id_idx" ON "public"."equipment_pack_items" USING "btree" ("equipment_id");



CREATE INDEX "equipment_pack_items_pack_id_idx" ON "public"."equipment_pack_items" USING "btree" ("pack_id");
...
CREATE UNIQUE INDEX "idx_equipment_units_qr_code_value_unique" ON "public"."equipment_units" USING "btree" ("qr_code_value") WHERE ("qr_code_value" IS NOT NULL);



CREATE INDEX "idx_equipment_units_qr_generated_at" ON "public"."equipment_units" USING "btree" ("qr_code_generated_at" DESC);
...
CREATE INDEX "idx_eual_event_type_created_at" ON "public"."equipment_unit_activity_logs" USING "btree" ("event_type", "created_at" DESC);



CREATE INDEX "idx_eual_rental_created_at" ON "public"."equipment_unit_activity_logs" USING "btree" ("rental_id", "created_at" DESC);



CREATE INDEX "idx_eual_unit_created_at" ON "public"."equipment_unit_activity_logs" USING "btree" ("equipment_unit_id", "created_at" DESC);
...
CREATE INDEX "idx_rpus_preparation_scanned_at" ON "public"."rental_preparation_unit_scans" USING "btree" ("preparation_id", "scanned_at" DESC);



CREATE INDEX "idx_rpus_rental_scanned_at" ON "public"."rental_preparation_unit_scans" USING "btree" ("rental_id", "scanned_at" DESC);



CREATE UNIQUE INDEX "idx_rpus_unique_counted_per_unit" ON "public"."rental_preparation_unit_scans" USING "btree" ("preparation_id", "equipment_unit_id") WHERE (("counted" = true) AND ("equipment_unit_id" IS NOT NULL));



CREATE INDEX "idx_rpus_unit_scanned_at" ON "public"."rental_preparation_unit_scans" USING "btree" ("equipment_unit_id", "scanned_at" DESC);
...
CREATE INDEX "idx_rrus_rental_scanned_at" ON "public"."rental_return_unit_scans" USING "btree" ("rental_id", "scanned_at" DESC);



CREATE INDEX "idx_rrus_return_scanned_at" ON "public"."rental_return_unit_scans" USING "btree" ("return_id", "scanned_at" DESC);



CREATE UNIQUE INDEX "idx_rrus_unique_counted_per_unit" ON "public"."rental_return_unit_scans" USING "btree" ("return_id", "equipment_unit_id") WHERE (("counted" = true) AND ("equipment_unit_id" IS NOT NULL));



CREATE INDEX "idx_rrus_unit_scanned_at" ON "public"."rental_return_unit_scans" USING "btree" ("equipment_unit_id", "scanned_at" DESC);
...
CREATE INDEX "rental_activity_logs_rental_id_idx" ON "public"."rental_activity_logs" USING "btree" ("rental_id", "created_at" DESC);



CREATE INDEX "rental_document_requests_decision_attempts_idx" ON "public"."rental_document_requests" USING "btree" ("decision_attempts");



CREATE INDEX "rental_document_requests_rental_id_idx" ON "public"."rental_document_requests" USING "btree" ("rental_id");



CREATE INDEX "rental_document_requests_status_idx" ON "public"."rental_document_requests" USING "btree" ("status");



CREATE INDEX "rental_document_requests_token_idx" ON "public"."rental_document_requests" USING "btree" ("token");



CREATE INDEX "rental_document_shares_document_id_idx" ON "public"."rental_document_shares" USING "btree" ("document_id");



CREATE INDEX "rental_document_shares_token_idx" ON "public"."rental_document_shares" USING "btree" ("token");



CREATE INDEX "rental_dossier_entries_parent_id_idx" ON "public"."rental_dossier_entries" USING "btree" ("parent_id");



CREATE INDEX "rental_dossier_entries_rental_id_idx" ON "public"."rental_dossier_entries" USING "btree" ("rental_id");



CREATE INDEX "rental_dossier_share_access_codes_share_id_idx" ON "public"."rental_dossier_share_access_codes" USING "btree" ("share_id");



CREATE INDEX "rental_dossier_share_access_sessions_share_id_idx" ON "public"."rental_dossier_share_access_sessions" USING "btree" ("share_id");



CREATE INDEX "rental_dossier_shares_rental_id_idx" ON "public"."rental_dossier_shares" USING "btree" ("rental_id");



CREATE INDEX "rental_dossier_shares_token_idx" ON "public"."rental_dossier_shares" USING "btree" ("token");



CREATE INDEX "rental_dossier_whitelist_emails_rental_id_idx" ON "public"."rental_dossier_whitelist_emails" USING "btree" ("rental_id");



CREATE INDEX "rental_dossier_whitelist_verifications_rental_id_idx" ON "public"."rental_dossier_whitelist_verifications" USING "btree" ("rental_id");



CREATE INDEX "rental_insurance_services_rental_id_idx" ON "public"."rental_insurance_services" USING "btree" ("rental_id");



CREATE INDEX "rental_insurance_services_service_record_id_idx" ON "public"."rental_insurance_services" USING "btree" ("service_record_id");



CREATE INDEX "rental_milestone_items_idx" ON "public"."rental_milestone_items" USING "btree" ("milestone_id");



CREATE INDEX "rental_milestone_personnel_idx" ON "public"."rental_milestone_personnel" USING "btree" ("milestone_id");



CREATE INDEX "rental_milestone_vehicles_idx" ON "public"."rental_milestone_vehicles" USING "btree" ("milestone_id");



CREATE INDEX "rental_milestones_rental_idx" ON "public"."rental_milestones" USING "btree" ("rental_id", "start_at");



CREATE INDEX "rental_other_services_rental_id_idx" ON "public"."rental_other_services" USING "btree" ("rental_id");



CREATE INDEX "rental_other_services_service_record_id_idx" ON "public"."rental_other_services" USING "btree" ("service_record_id");



CREATE INDEX "rental_personnel_services_rental_id_idx" ON "public"."rental_personnel_services" USING "btree" ("rental_id");



CREATE INDEX "rental_personnel_services_service_record_id_idx" ON "public"."rental_personnel_services" USING "btree" ("service_record_id");



CREATE INDEX "service_records_category_idx" ON "public"."service_records" USING "btree" ("category");



CREATE INDEX "service_records_end_date_idx" ON "public"."service_records" USING "btree" ("end_date");



CREATE INDEX "service_records_status_idx" ON "public"."service_records" USING "btree" ("status");
...
CREATE OR REPLACE TRIGGER "trg_equipment_units_qr_fields" BEFORE INSERT OR UPDATE ON "public"."equipment_units" FOR EACH ROW EXECUTE FUNCTION "public"."ensure_equipment_unit_qr_fields"();
...
CREATE OR REPLACE TRIGGER "trg_track_equipment_unit_changes" AFTER INSERT OR UPDATE ON "public"."equipment_units" FOR EACH ROW EXECUTE FUNCTION "public"."track_equipment_unit_changes"();
...
ALTER TABLE ONLY "public"."equipment_unit_activity_logs"
    ADD CONSTRAINT "equipment_unit_activity_logs_equipment_id_fkey" FOREIGN KEY ("equipment_id") REFERENCES "public"."equipment"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."equipment_unit_activity_logs"
    ADD CONSTRAINT "equipment_unit_activity_logs_equipment_unit_id_fkey" FOREIGN KEY ("equipment_unit_id") REFERENCES "public"."equipment_units"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."equipment_unit_activity_logs"
    ADD CONSTRAINT "equipment_unit_activity_logs_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."rental_activity_logs"
    ADD CONSTRAINT "rental_activity_logs_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "public"."app_users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_activity_logs"
    ADD CONSTRAINT "rental_activity_logs_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_document_requests"
    ADD CONSTRAINT "rental_document_requests_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "public"."rental_documents"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_document_requests"
    ADD CONSTRAINT "rental_document_requests_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_document_shares"
    ADD CONSTRAINT "rental_document_shares_document_id_fkey" FOREIGN KEY ("document_id") REFERENCES "public"."rental_documents"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."rental_dossier_entries"
    ADD CONSTRAINT "rental_dossier_entries_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "public"."rental_dossier_entries"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_entries"
    ADD CONSTRAINT "rental_dossier_entries_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_share_access_codes"
    ADD CONSTRAINT "rental_dossier_share_access_codes_share_id_fkey" FOREIGN KEY ("share_id") REFERENCES "public"."rental_dossier_shares"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_share_access_sessions"
    ADD CONSTRAINT "rental_dossier_share_access_sessions_share_id_fkey" FOREIGN KEY ("share_id") REFERENCES "public"."rental_dossier_shares"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_shares"
    ADD CONSTRAINT "rental_dossier_shares_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_shares"
    ADD CONSTRAINT "rental_dossier_shares_root_entry_id_fkey" FOREIGN KEY ("root_entry_id") REFERENCES "public"."rental_dossier_entries"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_whitelist_emails"
    ADD CONSTRAINT "rental_dossier_whitelist_emails_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_dossier_whitelist_verifications"
    ADD CONSTRAINT "rental_dossier_whitelist_verifications_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_insurance_services"
    ADD CONSTRAINT "rental_insurance_services_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_insurance_services"
    ADD CONSTRAINT "rental_insurance_services_service_record_id_fkey" FOREIGN KEY ("service_record_id") REFERENCES "public"."service_records"("id");
...
ALTER TABLE ONLY "public"."rental_milestone_items"
    ADD CONSTRAINT "rental_milestone_items_milestone_id_fkey" FOREIGN KEY ("milestone_id") REFERENCES "public"."rental_milestones"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestone_items"
    ADD CONSTRAINT "rental_milestone_items_rental_item_id_fkey" FOREIGN KEY ("rental_item_id") REFERENCES "public"."rental_items"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestone_personnel"
    ADD CONSTRAINT "rental_milestone_personnel_milestone_id_fkey" FOREIGN KEY ("milestone_id") REFERENCES "public"."rental_milestones"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestone_personnel"
    ADD CONSTRAINT "rental_milestone_personnel_personnel_id_fkey" FOREIGN KEY ("personnel_id") REFERENCES "public"."app_users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestone_vehicles"
    ADD CONSTRAINT "rental_milestone_vehicles_milestone_id_fkey" FOREIGN KEY ("milestone_id") REFERENCES "public"."rental_milestones"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestone_vehicles"
    ADD CONSTRAINT "rental_milestone_vehicles_vehicle_id_fkey" FOREIGN KEY ("vehicle_id") REFERENCES "public"."vehicles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_milestones"
    ADD CONSTRAINT "rental_milestones_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_other_services"
    ADD CONSTRAINT "rental_other_services_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_other_services"
    ADD CONSTRAINT "rental_other_services_service_record_id_fkey" FOREIGN KEY ("service_record_id") REFERENCES "public"."service_records"("id");



ALTER TABLE ONLY "public"."rental_personnel_services"
    ADD CONSTRAINT "rental_personnel_services_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_personnel_services"
    ADD CONSTRAINT "rental_personnel_services_service_record_id_fkey" FOREIGN KEY ("service_record_id") REFERENCES "public"."service_records"("id");



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_equipment_id_fkey" FOREIGN KEY ("equipment_id") REFERENCES "public"."equipment"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_equipment_unit_id_fkey" FOREIGN KEY ("equipment_unit_id") REFERENCES "public"."equipment_units"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_expected_equipment_id_fkey" FOREIGN KEY ("expected_equipment_id") REFERENCES "public"."equipment"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_preparation_id_fkey" FOREIGN KEY ("preparation_id") REFERENCES "public"."rental_preparation"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_preparation_item_id_fkey" FOREIGN KEY ("preparation_item_id") REFERENCES "public"."rental_preparation_items"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_preparation_unit_scans"
    ADD CONSTRAINT "rental_preparation_unit_scans_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_equipment_id_fkey" FOREIGN KEY ("equipment_id") REFERENCES "public"."equipment"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_equipment_unit_id_fkey" FOREIGN KEY ("equipment_unit_id") REFERENCES "public"."equipment_units"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_expected_equipment_id_fkey" FOREIGN KEY ("expected_equipment_id") REFERENCES "public"."equipment"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_rental_id_fkey" FOREIGN KEY ("rental_id") REFERENCES "public"."rentals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_return_id_fkey" FOREIGN KEY ("return_id") REFERENCES "public"."rental_returns"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."rental_return_unit_scans"
    ADD CONSTRAINT "rental_return_unit_scans_return_item_id_fkey" FOREIGN KEY ("return_item_id") REFERENCES "public"."rental_return_items"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."rentals"
    ADD CONSTRAINT "rentals_delivery_offer_id_fkey" FOREIGN KEY ("delivery_offer_id") REFERENCES "public"."delivery_offers"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_records"
    ADD CONSTRAINT "service_records_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."equipment_categories"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."service_records"
    ADD CONSTRAINT "service_records_subcategory_id_fkey" FOREIGN KEY ("subcategory_id") REFERENCES "public"."equipment_subcategories"("id") ON DELETE SET NULL;
...
CREATE POLICY "Anon full access equipment_unit_activity_logs" ON "public"."equipment_unit_activity_logs" USING (true) WITH CHECK (true);
...
CREATE POLICY "Anon full access rental_preparation_unit_scans" ON "public"."rental_preparation_unit_scans" USING (true) WITH CHECK (true);
...
CREATE POLICY "Anon full access rental_return_unit_scans" ON "public"."rental_return_unit_scans" USING (true) WITH CHECK (true);
...
GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_url"("p_payload" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_url"("p_payload" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_url"("p_payload" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_value"("p_unit_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_value"("p_unit_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."build_equipment_unit_qr_value"("p_unit_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."ensure_equipment_unit_qr_fields"() TO "anon";
GRANT ALL ON FUNCTION "public"."ensure_equipment_unit_qr_fields"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."ensure_equipment_unit_qr_fields"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."log_equipment_unit_event"("p_equipment_unit_id" "uuid", "p_equipment_id" "uuid", "p_event_type" "text", "p_message" "text", "p_payload" "jsonb", "p_severity" "text", "p_source" "text", "p_rental_id" "uuid", "p_created_by" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."log_equipment_unit_event"("p_equipment_unit_id" "uuid", "p_equipment_id" "uuid", "p_event_type" "text", "p_message" "text", "p_payload" "jsonb", "p_severity" "text", "p_source" "text", "p_rental_id" "uuid", "p_created_by" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_equipment_unit_event"("p_equipment_unit_id" "uuid", "p_equipment_id" "uuid", "p_event_type" "text", "p_message" "text", "p_payload" "jsonb", "p_severity" "text", "p_source" "text", "p_rental_id" "uuid", "p_created_by" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."track_equipment_unit_changes"() TO "anon";
GRANT ALL ON FUNCTION "public"."track_equipment_unit_changes"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_equipment_unit_changes"() TO "service_role";
...
GRANT ALL ON TABLE "public"."delivery_offers" TO "anon";
GRANT ALL ON TABLE "public"."delivery_offers" TO "authenticated";
GRANT ALL ON TABLE "public"."delivery_offers" TO "service_role";
...
GRANT ALL ON TABLE "public"."equipment_accessories" TO "anon";
GRANT ALL ON TABLE "public"."equipment_accessories" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_accessories" TO "service_role";
...
GRANT ALL ON TABLE "public"."equipment_pack_items" TO "anon";
GRANT ALL ON TABLE "public"."equipment_pack_items" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_pack_items" TO "service_role";



GRANT ALL ON TABLE "public"."equipment_packs" TO "anon";
GRANT ALL ON TABLE "public"."equipment_packs" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_packs" TO "service_role";
...
GRANT ALL ON TABLE "public"."equipment_unit_rental_history" TO "anon";
GRANT ALL ON TABLE "public"."equipment_unit_rental_history" TO "authenticated";
GRANT ALL ON TABLE "public"."equipment_unit_rental_history" TO "service_role";
...
GRANT ALL ON TABLE "public"."rental_document_shares" TO "anon";
GRANT ALL ON TABLE "public"."rental_document_shares" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_document_shares" TO "service_role";
...
GRANT ALL ON TABLE "public"."rental_dossier_entries" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_entries" TO "service_role";



GRANT ALL ON TABLE "public"."rental_dossier_share_access_codes" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_share_access_codes" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_share_access_codes" TO "service_role";



GRANT ALL ON TABLE "public"."rental_dossier_share_access_sessions" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_share_access_sessions" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_share_access_sessions" TO "service_role";



GRANT ALL ON TABLE "public"."rental_dossier_shares" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_shares" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_shares" TO "service_role";



GRANT ALL ON TABLE "public"."rental_dossier_whitelist_emails" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_whitelist_emails" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_whitelist_emails" TO "service_role";



GRANT ALL ON TABLE "public"."rental_dossier_whitelist_verifications" TO "anon";
GRANT ALL ON TABLE "public"."rental_dossier_whitelist_verifications" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_dossier_whitelist_verifications" TO "service_role";



GRANT ALL ON TABLE "public"."rental_insurance_services" TO "anon";
GRANT ALL ON TABLE "public"."rental_insurance_services" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_insurance_services" TO "service_role";
...
GRANT ALL ON TABLE "public"."rental_milestone_items" TO "anon";
GRANT ALL ON TABLE "public"."rental_milestone_items" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_milestone_items" TO "service_role";



GRANT ALL ON TABLE "public"."rental_milestone_personnel" TO "anon";
GRANT ALL ON TABLE "public"."rental_milestone_personnel" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_milestone_personnel" TO "service_role";



GRANT ALL ON TABLE "public"."rental_milestone_vehicles" TO "anon";
GRANT ALL ON TABLE "public"."rental_milestone_vehicles" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_milestone_vehicles" TO "service_role";



GRANT ALL ON TABLE "public"."rental_milestones" TO "anon";
GRANT ALL ON TABLE "public"."rental_milestones" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_milestones" TO "service_role";



GRANT ALL ON TABLE "public"."rental_other_services" TO "anon";
GRANT ALL ON TABLE "public"."rental_other_services" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_other_services" TO "service_role";



GRANT ALL ON TABLE "public"."rental_personnel_services" TO "anon";
GRANT ALL ON TABLE "public"."rental_personnel_services" TO "authenticated";
GRANT ALL ON TABLE "public"."rental_personnel_services" TO "service_role";
